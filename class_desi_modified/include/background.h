...
struct background
{
  ...
  /** DESI dark energy model parameters */
  enum desi_de_model {
    desi_none,        /**< Standard CPL parametrization */
    desi_thawing,     /**< Thawing quintessence model */
    desi_emergent,    /**< Emergent dark energy model */
    desi_mirage       /**< Mirage dark energy model */
  } desi_model;       /**< DESI dark energy model selector */
  
  double thawing_p;           /**< Power index p for algebraic thawing */
  double emergent_delta;      /**< Transition steepness Δ for emergent model */
  double emergent_zt;         /**< Transition redshift zt for emergent model */
  //@}
